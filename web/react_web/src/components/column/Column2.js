...
import beach_image from  '../../../public/src/image/publishing/beach.jpg';
          ...
          <div>
            <div className="burger-box">
              ...
              <div className="column-image-container">
                <img className="column-image" key={beach_image} src={beach_image}/>
              </div>
              ...
              <div className="column-text-container">
                ...
                <p className="column-body-desc"> 멘탈이 강하다는 것은 <strong>중심의 문제</strong>이기 때문이다.</p>
                <p className="column-body-desc"> 중심이 있는 사람은 쉽게 휩쓸리지 않는다. 얽매이지 않는다. 즉 개의치 않는다는 말이다.</p>
                  ...
                  <p className="column-body-desc"> 고로 <strong>융통성, 무소유, 중용의 도, 자유</strong> 등의 개념은 통한다. </p>
              </div>
              <div>
